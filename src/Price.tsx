...
function Price({navigation,route}: formTypes): JSX.Element {
  ...
  const getPrice = () => {
    console.log(registedNumber,parkigArray[index].registedNumber,"registed number");
  ...
  console.log(registedNumber,price);
  return (
    <SafeAreaView >
      <View style={styles.sectionContainer}>
        <Text style={{fontSize:20, fontWeight:'700'}}>Vechile details {registedNumber}</Text>
        <View style={{  borderWidth:3, backgroundColor:'#fff'}}>
          <Text style={{fontSize:18, fontFamily:'700'}}>Price for the {hours} hours is ${price}</Text>
        </View>
